...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="flex-container">
            ...
            <div class="flex-row">
                ...
                <div class="text-input-registration">
                    <asp:TextBox ID="txtPassword" runat="server" MaxLength="12" TextMode="Password" Width="200px" Height="20px"></asp:TextBox>
                    <asp:RequiredFieldValidator
            ...
            <div class="flex-row">
                ...
                <div class="text-input-registration">
                    <asp:TextBox ID="txtConfirmPassword" MaxLength="12" runat="server" TextMode="Password" Width="200px" Height="20px"></asp:TextBox>
                    <asp:RequiredFieldValidator
        ...
        <div class="flex-row">
            ...
            <div class="text-input-registration">
                <asp:DropDownList ID="dlSecretQuestion" runat="server" Width="275px" Height="25px" BackColor="#8fbc8f">
                </asp:DropDownList>
