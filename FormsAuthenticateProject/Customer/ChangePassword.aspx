<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Customer.Master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="FormsAuthenticateProject.Customer.ChangePassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        <h3 style="text-align: center; margin: 25px 0; font-size: 22px">Change Password</h3>
        <div class="flex-container">
            ...
            <asp:Panel ID="pnlChangePassword" runat="server" Visible="false" CssClass="flex-container">
                ...
                <div class="text-label txt-password-align">
                    <asp:Label ID="lblConfirmNewPassword" runat="server" Text="Confirm Password"></asp:Label>
                    <div class="text-input">
                        <asp:TextBox ID="txtConfirmNewPassword" Height="20px" MaxLength="12" runat="server"
